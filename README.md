...
Tüm araçlar birbirinden bağımsız **10 ayrı menü/tab** olarak ayrılmış olup, her birinin kendine özel thread, timeout, port profili, wordlist ve payload konfigürasyonları ve anlık **Canlı İstek/Yanıt Logları (Live Execution Audit Logs)** bulunmaktadır:
